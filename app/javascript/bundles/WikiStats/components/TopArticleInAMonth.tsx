...
import { getTopArticleInAMonth } from '../services/ArticlesApiService';
import { Article } from '../types';


const TopArticleInAMonth = () => {
  ...
  const getArticle = async (values: any) => {
    ...
    const response = await getTopArticleInAMonth(values.start_date.format('YYYY-MM'));
...
export default TopArticleInAMonth;
