...
import { getArticleViewsInAMonth } from '../services/ArticlesApiService';


const ArticleViewsInAMonth = () => {
  ...
  const getArticleViews = async (values: any) => {
    ...
    const response = await getArticleViewsInAMonth(values.title, values.start_date.format('YYYY-MM'));
...
export default ArticleViewsInAMonth;
